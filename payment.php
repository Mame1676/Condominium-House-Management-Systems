...
<div id="wrapper">
	...
	<div class="shell">
		...
		<div class="container">
			...
			<div class="main">
			<!-- navigaation -->
			<i style="padding-left:50em"><a href="manageAcc.php?id=<?php echo$user_id?>">Manage Account</a>  |<a href="logout.php" >Logout</a>|</i>
			...
			<nav id="navigation">
				...
				<section class="cols">
					...
					<div class="featured">
<form  action="paymentinsertion.php" style="border:outset" name="form1" method="post" style="border-width:thick" onSubmit="">
...
<tr>
	...
	<font color="red"><span id="amount_error" class="error"></span></font>
	</td>
</tr>
<tr>
	<td class="td">Date:</td>
...
<tr>
	...
	<font color="red"><span id="prepayment_error" class="error"></span></font>
	</td>
</tr>
...
<tr>
	...
	<td class="td"><input type="text" name="BankName" class="input" id="BankName" maxlength="">
...
/*
 ...
 include('connection.php');
	  ...
	  $query1=mysql_query("select WinnerId from winner");
	   while($row=mysql_fetch_array($query1))
	  {
	  $id=$row['WinnerId'];
	  
	   $query=mysql_query("select * from payment where WinnerId='$id'");
...
<th colspan="2"><input type="submit" name="submit" style="height:35px;width:120px" onClick="return validation()" value="Register payment"></th>
</table>
</form>
