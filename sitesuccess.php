...
<tr>
	...
	<td class="td"><select name="City"  class="input" id="City" >    
	  						  <option value='0'>-----Select-------</option>        
                              <option value='debereberhan '>debereberhan</option>
                            </select>
...
<tr>
	...
	<td class="td"><select name="Wereda"  class="input" id="Wereda">    
	  						  <option value='0'>-----Select-------</option>        
                              <option value='debreberhan'>debereberhan</option>
                            </select>
...
<tr>
	...
	<td class="td"><select name="Kebele"  class="input" id="Kebele" >    
                              ...
                              <option value='08'>keble08</option>
...
<tr><td></td><td><font color="green"><span id="" class="">Inserted successfuly</span></font>
	</td></tr>
